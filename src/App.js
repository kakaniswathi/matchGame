...
class App extends Component {
  ...
  accordingToCateGory = () => {
    ...
    const basedTab = imagesList.filter(eachImg => eachImg.category === tabId)
    return basedTab
  }
  ...
  checking = id => {
    ...
    if (id === imgId) {
      ...
      this.setState(prevState => ({
        ...
        image: imagesList[randomNum].imageUrl,
  ...
  gameIsRunning = () => {
    ...
    const filterList = this.accordingToCateGory(imagesList)
    return (
      <div className="content-container">
        <div className="bottom-container">
          <div className="game-area">
            <img className="main-img" src={image} alt="match" />
  ...
  render() {
    ...
    return (
      <div className="main-bg">
        ...
        {timer > 0 ? this.gameIsRunning() : this.resultPage()}
      </div>
    )
  }
}
